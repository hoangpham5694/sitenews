...
@section('header')
<title>Admin::Sửa Bài viết hệ thống</title>


@endsection
@section('title','Sửa bài hệ thống')
@section('content')
...
<div class="col-md-10" >
    ...
    <div class="form-group">
      ...
      <div class="col-sm-9">
        <input type="text" class="form-control" value="{{$post->title}}" name="txtTitle" id="txtTitle" placeholder="Vui lòng nhập tiêu đề">
  ...
  <div class="form-group">
    <div class="col-sm-offset-3 col-sm-9">
      <button type="submit" ng-disabled="frmTeacher.$invalid"  class="btn btn-default">Sửa bài viết</button>
    </div>
  </div>
</form>
